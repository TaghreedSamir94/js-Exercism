...
export function remainingMinutesInOven(actualMinutesInOven) {
  let number_of_minutes_remaining =EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return  number_of_minutes_remaining;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
 let total_working_time = preparationTimeInMinutes(numberOfLayers) +  actualMinutesInOven
